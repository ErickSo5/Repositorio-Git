<?php
    ...
    class Proveedor{
        ...
        public function crear(){
            ...
            $sql = "INSERT INTO proveedores (nombre_farmaceutica,direccion_farmaceutica,telefono_farmaceutica,correo_farmaceutica,contacto)
                VALUES ('{$this->nombre_farmaceutica}',  '{$this->direccion_farmaceutica}',   '{$this->telefono_farmaceutica}',  '{$this->correo_farmaceutica}',  '{$this->contacto}')";
        ...
        public function editar(){
            ...
            $sql = "UPDATE proveedores SET nombre_farmaceutica = '{$this->nombre_farmaceutica}', direccion_farmaceutica = '{$this->direccion_farmaceutica}', telefono_farmaceutica = '{$this->telefono_farmaceutica}', correo_farmaceutica = '{$this->correo_farmaceutica}', contacto = '{$this->contacto}' WHERE id_proveedor = '{$this->id_proveedor}'";
            $this->con->consultaSimple($sql);
            return true;
        }
    }

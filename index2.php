...
<head>
<meta charset="utf-8">
    <title>Veterinaria ElPotrillo</title>
    <link href="img/CaballoN.png" rel="icon">
        ...
        <div class="row py-3 px-lg-5">
            <div class="col-lg-4">
                <a href="" class="navbar-brand d-none d-lg-block">
                    <h1 class="m-0 display-5 text-capitalize"> <img src="img/potrillo.png" width="90" alt="MDN" /><span class="text-primary">  Veterinaria</span>ElPotrillo</h1>
                </a>
            </div>
...
<section>
 ...
 <!-- Back to Top -->
  <!-- Back to Top -->
  <a id="back-to-top" href="#" class="btn btn-lg btn-primary">
    <img src="icons/arrow-up-circle-fill.png" width="25" alt="MDN" />
</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.addEventListener('scroll', function() {
        if (window.scrollY > 300) { // Ajusta el valor según cuando quieras que aparezca el botón
    ...
    backToTopButton.addEventListener('click', function(event) {
        event.preventDefault(); // Evita que el enlace realice su comportamiento por defecto
        window.scrollTo({
            top: 0,

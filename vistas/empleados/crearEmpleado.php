...
<section>
    ...
    <div>
        ...
        <tr class="espacio">
            <td aling="right"> <label for="fecha_nacimiento">Fecha de nacimiento:</label></td><td><input type="date" class="form-control" name="fecha_nacimiento" id="fecha_nacimiento" placeholder="Ingresa la fecha de nacimiento" autofocus required min="1904-12-31" max="2006-08-24"></td>
        ...
        <tr class="espacio">
            <td aling="right"> <label for="sueldo">Sueldo:</label></td><td><input type="text" class="form-control" name="sueldo" id="sueldo" placeholder="Ingresa el sueldo" min="1" pattern="^[0-9.]+{1,254}" onpaste="return false;" onDrop="return false;" oninvalid="this.setCustomValidity('Ingrese solo numeros positivos')" oninput="this.setCustomValidity('')" autofocus required></td>

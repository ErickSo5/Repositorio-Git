...
<section>
    <div class="container">
        ...
        <tr class="espacio">
            <td aling="right"> <label for="fecha_nacimiento">Fecha de nacimiento:</label></td><td><input type="date" class="form-control" name="fecha_nacimiento" id="fecha_nacimiento" min="1904-12-31" max="2006-08-24" value="<?php echo $row['fecha_nacimiento']; ?>"></td>

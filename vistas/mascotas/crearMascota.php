...
<section>
    ...
    <div>
        ...
        <tr class="espacio">
        <td aling="right"> <label for="telefono_persona">Telefono de la Persona:</label></td><td><input type="text" class="form-control" name="telefono_persona" id="telefono_persona" placeholder="Ingresa el telefono de la persona" pattern="[0-9\u00C0-\u017F ]{10}" oninvalid="this.setCustomValidity('Ingrese solo números y diez dijitos')" oninput="this.setCustomValidity('')" autofocus required></td>

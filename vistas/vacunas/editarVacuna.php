...
<section>
    <div class="container">
        ...
        <tr class="espacio">
            <td aling="right"> <label for="fecha_expiracion">Fecha de expiracion de la vacuna:</label></td><td><input type="date" class="form-control" name="fecha_expiracion" id="fecha_expiracion" required min="<?php $hoy = date('Y-m-d'); echo $hoy; ?>" Value="<?php echo $row['fecha_expiracion']; ?>"></td>
        ...
        <tr class="espacio">
            <td aling="right"> <label for="fecha_elaboracion">Fecha de elaboración de la vacuna:</label></td><td><input type="date" class="form-control" name="fecha_elaboracion" id="fecha_elaboracion" required max="<?php $ayer = date('Y-m-d'); echo $ayer; ?>" Value="<?php echo $row['fecha_elaboracion']; ?>"></td>
        ...
        <td aling="center" colspan="2"><input type="submit" onclick="ValidarFechas()" name="registrar" class="btn btn-primary" value="Registrar" title="Registrar"></td> 
            </tr>
        </form>
        </table>
            <!-- termina la tabla -->

...
<section>
    ...
    <div>
        ...
        <tr class="espacio">
            <td aling="right"> <label for="fecha_elaboracion">Fecha de elaboración:</label></td><td><input type="date" class="form-control" name="fecha_elaboracion" id="fecha_elaboracion" placeholder="Ingresa la fecha de elaboración" autofocus required required max="<?php $ayer = date('Y-m-d'); echo $ayer; ?>" td>

        </tr>

        <tr class="espacio">
            <td aling="right"> <label for="cantidad">Cantidad:</label></td><td><input type="number" class="form-control" name="cantidad" id="cantidad" placeholder="Ingresa la cantidad" min="1" pattern="^[0-9]+{1,254}" onpaste="return false;" onDrop="return false;" oninvalid="this.setCustomValidity('No se aceptan letras, números negativos y solo el cero')" oninput="this.setCustomValidity('')" autofocus required></td>

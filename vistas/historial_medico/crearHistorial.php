...
<section>
    ...
    <div>
        ...
        <tr class="espacio">
            <td aling="right"> <label for="fecha_vacuna">Fecha de la vacuna:</label></td><td><input type="date" class="form-control" name="fecha_vacuna" id="fecha_vacuna" placeholder="Ingresa la fecha" autofocus required required max="<?php $ayer = date('Y-m-d'); echo $ayer; ?>"></td>

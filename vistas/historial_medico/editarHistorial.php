...
<section>
    <div class="container">
        ...
        <tr class="espacio">
            <td aling="right"> <label for="fecha_vacuna">Fecha de la vacuna:</label></td><td><input type="date" class="form-control" name="fecha_vacuna" id="fecha_vacuna" required max="<?php $ayer = date('Y-m-d'); echo $ayer; ?>" Value="<?php echo $row['fecha_vacuna']; ?>"></td>
